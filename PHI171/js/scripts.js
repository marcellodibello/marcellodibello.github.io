...
/*
var today = new Date();
var part1End = new Date(2014,8,20);
var part2start = new Date(2014,8,21);
var part2End = new Date(2014,9,4);
var part3start = new Date(2014,9,5);
var part3End = new Date(2014,9,25);
var part4start = new Date(2014,9,26);
var part4End = new Date(2014,10,13);
var part5start = new Date(2014,10,15);
var part5End = new Date(2014,10,29);
var part6start = new Date(2014,10,30);
var part6End = new Date(2014,11,13);
